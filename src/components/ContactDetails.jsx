      ...
      <Container>
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-3xl">
          ...
          <ul className=" mx-7 list-disc">
            <li className="mt-4 text-lg text-gray-400">
              Do you feel there are too many car brands, models or engines to
              choose from?{' '}
            </li>
            <li className="mt-4 text-lg text-gray-400">
              Do you feel you don’t know what car and engine to get?{' '}
            </li>
            <li className="mt-4 text-lg text-gray-400">
              Do you want help understanding what makes sense for you and your
              needs?
            </li>
          </ul>
